...
+ เราอยู่ที่เมืองนี้สักสองสามวันรึเปล่า?
```
We have been only walking.
If we don’t work a little bit, we will pass through this country without doing any request here at all.
* **เราได้เดินเพียงอย่างเดียว ถ้าเราไม่ทำงานสักนิดเราจะผ่านประเทศนี้โดยไม่ต้องขออะไรเลย**

As we are having a journey around the countries, I also want to work in this country as well.
* **ขณะที่เรากำลังเดินทางไปทั่วประเทศก็อยากทำงานในประเทศนี้เช่นกัน**

However, if Mile, if you worry in this country then we will head to the border」 (Rena).
* **อย่างไรก็ตามถ้า Mile ถ้าคุณกังวลในประเทศนี้เราจะมุ่งหน้าไปยังชายแดน」 (Rena)**
...
* **ค่าขอขึ้นอยู่กับประเภทและจำนวนเครื่องเทศที่คุณสามารถหาได้**

More details at the meeting」 (Notice).
* **รายละเอียดเพิ่มเติมได้ที่การประชุม」 (Notice)**

```diff
「… Let’s say we accept it, how do you plan to get spices?.
+ 「 ... สมมติว่าเรายอมรับแล้วคุณวางแผนจะหาเครื่องเทศอย่างไร?
```
...
* **นี่เป็นครั้งแรกที่คุณไปที่เมืองนี้ใช่ไหม? คุณไม่มีการเชื่อมต่อใด ๆ หรือคุณรู้ราคาตลาดของเครื่องเทศในพื้นที่นี้ ...**

Beside, you don’t even that good at cooking, aren’t you?」 (Rena).
* **ข้างนอกคุณไม่ค่อยทำอาหารใช่มั้ย」 (Rena)**
...
+ 「ไม่เป็นไรพวกเขาต้องการสินค้าเพียงเล็กน้อยเท่านั้น
```
Besides, if they want to purchase spices, they usually ask the commercial guild to get it.
* **นอกจากนี้หากพวกเขาต้องการที่จะซื้อเครื่องเทศที่พวกเขามักจะถามสมาคมการค้าที่จะได้รับมัน แต่ตอนนี้ลูกค้าคนนี้ได้ขอให้สมาคมนักล่าสัตว์ได้รับมัน ... 」 (ไมล์)**
...
+ 「ข้างๆไม่มีคำร้องขออื่นที่น่าสนใจไม่ใช่แม้แต่คำขอล่าผี
```
And do something different occasionally, it may be a good experience for us as well, is that okay, everyone?」 (Mile).
* **และทำบางสิ่งบางอย่างที่แตกต่างกันเป็นครั้งคราวก็อาจเป็นประสบการณ์ที่ดีสำหรับเราได้เช่นกันทุกครั้งหรือไม่? 」 (ไมล์)**
...
+ 「คำขอชนิดนี้ลูกค้าอาจสั่งซื้อเครื่องเทศหลายประเภท ดังนั้นอย่าลอกออก!
```
We also need to confirm the conditions at the meeting place before accepting the request」 (Pauline).
* **เราจำเป็นต้องยืนยันเงื่อนไขในสถานที่นัดพบก่อนที่จะยอมรับคำขอ」 (Pauline)**
...
```diff
「Oh, will you accept that request?.
+ 「โอ้คุณจะยอมรับคำขอนั้นหรือไม่?
```
I often got spices from other city.
* **ฉันมักจะได้เครื่องเทศจากเมืองอื่น ยังคงกำหนดการเดินทางมาถึงล่าช้าดังนั้นฉันมีปัญหา!**

… And about where to find it, it isn’t easy to collect it around that, even if you go to a store or a commercial guild, you still can’t it.
...
* **ดีถ้าฉันสามารถรับได้อย่างง่ายดายฉันจะไม่เกลียดที่จะขอผ่านสมาคมเธ่อซึ่งมีราคาแพงมากขึ้น」 (เจ้าของร้าน)**
...
+ 「ฉันได้เจรจากับบรรดาขุนนางและพ่อค้าที่มีเครื่องเทศราคาแพงและมีราคาสูงขึ้น ดังนั้นราคาในร้านของเราจึงกลายเป็นราคาแพงในช่วง 2-3 วันที่ผ่านมา
```
...
* **สำหรับลูกค้านี่คือ「ร้านค้าที่ใช้ความหรูหราแบบไม่ใส่ใจในการทำอาหาร」ดังนั้นจึงไม่น่าแปลกใจที่ราคาแพง คนเพียงบางครั้งกินในร้านอาหารของเราเพียงไม่กี่ครั้งต่อปี**

Now that I have already raked up from nearly place, and the spices still don’t arrive yet.
* **ตอนนี้ผมได้กวาดรายได้จากที่อื่นแล้วและเครื่องเทศก็ยังไม่มาถึง 」**
...
+ 「 ... พอลลีนทำไมคุณสนเรื่องเงื่อนไขตอนที่เราล้มเหลวขออะไรมาก?
```
You should know that, we always have a considerable amount of spices in my storage.
* **คุณควรทราบว่าเรามักมีเครื่องเทศจำนวนมากอยู่ในที่จัดเก็บของฉัน ที่แย่ที่สุดเราสามารถใช้มันเพื่อหลีกเลี่ยงความล้มเหลว ... 」 (Mile)**
